...
<head>
    ...
    <title>Super Admin Dashboard - DTS</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <main class="main-content">
        ...
        <div class="content-topbar">
            ...
            <div class="topbar-actions">
                <a href="../superadmin/users.php" class="btn btn-outline btn-sm">Manage Users</a>
                <a href="../documents/document.php" class="btn btn-gold btn-sm">View Documents</a>
            </div>
        </div>
        ...
        <div class="dashboard-hero">
            <div>
                ...
                <p>Get a high-level view of users, document processing, and approval performance.</p>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                <div>
                    ...
                    <p class="table-subtitle mb-0">Latest 5 system-wide document records.</p>
                </div>

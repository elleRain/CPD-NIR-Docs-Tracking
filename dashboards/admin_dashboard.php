    ...
    <main class="main-content">
        ...
        <div class="content-topbar">
            <div class="breadcrumb">
                <a href="<?php echo htmlspecialchars($dashboardUrl ?? 'admin_dashboard.php'); ?>">Home</a>
                <span class="breadcrumb-sep">&rsaquo;</span>
                <span class="breadcrumb-current">Dashboard</span>
            </div>
            <div class="topbar-actions">
                <a href="../documents/document.php" class="btn btn-outline btn-sm">View Documents</a>
                <a href="../documents/my_documents.php" class="btn btn-gold btn-sm">My Documents</a>
            </div>
        </div>
        ...
        <div class="dashboard-hero">
            <div>
                ...
                <p>Monitor document flow, pending reviews, and team activity at a glance.</p>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                <div>
                    ...
                    <p class="table-subtitle mb-0">Latest 5 document entries across the system.</p>
                </div>
                <a href="../documents/document.php" class="btn btn-sm btn-outline-secondary">View All</a>
            </div>
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT d.tracking_number, d.title, COALESCE(NULLIF(CONCAT_WS(' ', u.first_name, NULLIF(u.middle_name, ''), u.last_name), ''), u.username, 'Unknown User') AS full_name, s.status_name, s.status_id, d.created_at 
                                  FROM documents d 
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $origin = htmlspecialchars($row['full_name']);
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="../documents/document.php" class="btn btn-sm btn-light">Open</a>
                                </div>
                            </td>
                        </tr>
                        <?php

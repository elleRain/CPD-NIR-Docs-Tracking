...
<head>
    ...
    <style>
        .users-hero {
            background: linear-gradient(145deg, #0b2f73, #0f4db5);
            border-radius: 18px;
            padding: 1.05rem 1.2rem;
            box-shadow: 0 16px 36px rgba(12, 45, 106, 0.24);
            color: #fff;
            margin-bottom: 1rem;
        }
        ...
        .users-stat {
            ...
            box-shadow: 0 10px 26px rgba(14, 45, 108, 0.08);
        ...
        .users-stat:hover {
            ...
            box-shadow: 0 14px 30px rgba(14, 45, 108, 0.12);
        }
        ...
        .table-card {
            border: 1px solid #dbe6f8;
            border-radius: 16px;
            box-shadow: 0 14px 36px rgba(12, 45, 106, 0.08);
            overflow: hidden;
            background: #fff;
        }
        ...
        .invite-success-card {
            border: 1px solid #dbe6f8;
            border-radius: 16px;
            box-shadow: 0 10px 28px rgba(12, 45, 106, 0.08);
        }

        .modal-content {
            border: 1px solid #d8e3f5;
            border-radius: 16px;
            box-shadow: 0 22px 55px rgba(14, 45, 108, 0.2);
        }
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="container-fluid px-0">
            <div class="users-hero d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                <div>
                    <h5>Users & Roles Management</h5>
                    <p>Create accounts, assign roles, and control access in one secure workspace.</p>
                </div>
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-light btn-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#inviteLinkModal">
                        <i class="bi bi-link-45deg me-2"></i>
                        <span>Generate Link</span>
                    </button>
                    <button type="button" class="btn btn-warning btn-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#addUserModal">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    <div class="stat-card users-stat">
                        ...
                        <h4 class="fw-bold mb-0 stat-kpi"><?php echo $total_users; ?></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card users-stat">
                        ...
                        <h4 class="fw-bold mb-0 stat-kpi"><?php echo $total_superadmins; ?></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card users-stat">
                        ...
                        <h4 class="fw-bold mb-0 stat-kpi"><?php echo $total_admins; ?></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card users-stat">
                        ...
                        <h4 class="fw-bold mb-0 stat-kpi"><?php echo $total_staff; ?></h4>
                    </div>
                </div>
            </div>

            <?php if ($invite_url !== ''): ?>
                <div class="card border-0 shadow-sm mb-4 invite-success-card">
                    <div class="card-body">

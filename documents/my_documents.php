...
require_once dirname(__DIR__) . '/plugins/email_queue.php';
$user_id = (int)$_SESSION['user_id'];
$current_script = basename($_SERVER['PHP_SELF']);

if ($current_script === 'my_documents.php' && isset($_GET['tab']) && $_GET['tab'] === 'designated') {
    header('Location: document_review.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['add_document'])) {
        ...
        if (isset($_FILES['document_file'])) {
            ...
            if ($queued_email_jobs) {
                trigger_email_queue_worker();
            }
            if ($share_scope === 'individual') {
                header("Location: document_review.php?msg=added");
            } else {
                header("Location: my_documents.php?msg=added");
            }
            exit();
        }
    }
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="content-topbar">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-sep">&rsaquo;</span>
                <span class="breadcrumb-current">My Documents</span>
            </div>
            <div class="topbar-actions">
                <strong class="text-dark">My Documents</strong>
            </div>
        </div>
        ...
        // All My Documents (exclude individually shared uploads)
        ...
        $status_groups = [
            ...
            1 => ['label' => 'Pending', 'icon' => 'bi-clock', 'color' => 'text-secondary', 'bg' => 'bg-light'],
            ...
            if (!$has_docs) {
                ...
                foreach ($status_groups as $status_id => $group) {
                    ...
                    foreach ($grouped_docs[$status_id] as $row) {
                        ...
                        if ($row['created_by'] == $user_id && $row['status_id'] == 1) {
    ...
    <script>
        ...
        function openViewModal(data) {
            ...
            if (createdByLabelEl) createdByLabelEl.textContent = 'Created By';
